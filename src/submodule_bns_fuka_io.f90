...
!          "Call the SUBROUTINE import_fuka_id_params to read them."
!      PRINT *
!
!    ELSE
!
...
!
!      IF( THIS% eos1_fukaid == 1 )THEN ! If the EOS is polytropic
!
...
!      ELSE
!
!        PRINT *, "** ERROR in SUBROUTINE import_fuka_id_params!", &
